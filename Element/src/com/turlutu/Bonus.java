...
class Bonus extends AnglePhysicObject
{
	 ...
	 */
	public Bonus(AngleSpriteLayout textureB, AngleSpriteLayout textureV, AngleSpriteLayout textureR, float radius, float mass, float bounce, AngleSound soundJump, GameUI game)
	{
		super(0, 1);
		sndJump = soundJump;
