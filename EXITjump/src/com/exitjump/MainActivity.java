...
public class MainActivity extends AngleActivity
{
	...
	public void load()
	{
		...
		AngleSpriteLayout mLayoutOptions = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.options, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutGame = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.background_jeu, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutInstruction1 = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.instruction1, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutInstruction2 = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.instruction2, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutMenu = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.background_accueil, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutScore = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.score, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutOnLineScore = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.score_online, 0, 0, 320, 480);
		AngleSpriteLayout mLayoutGameOver = new AngleSpriteLayout(mGLSurfaceView,320,480,com.exitjump.R.drawable.game_over, 0, 0, 320, 480);
