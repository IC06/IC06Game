 ...
 * 
 */
public class Thomas extends AngleActivity
{
	@Override
	public void onCreate(Bundle savedInstanceState)
	{
		...
		//>Creamos un AngleSpriteLayout el cual especificar� como pintar el sprite
		//>(Consultar los otros constructores para ver mas opciones de creaci�n)
		...
		//Set screen position
		//>Fijamos la posici�n en pantalla
		mLogo.mPosition.set(160, 200); 
		//Add sprite to main view
		//>A�adimos el sprite a la View principal
