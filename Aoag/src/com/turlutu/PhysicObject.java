...
import com.android.angle.*;

public class PhysicObject extends AngleObject
{
	...
	public PhysicObject(int maxSegmentColliders, int maxCircleColliders)
	{
	 ...
	 * @return
	 */
	public boolean collide(PhysicObject other)
	{
	...
	public boolean test(PhysicObject other)
	{
		for (int mc = 0; mc < mCircleCollidersCount; mc++)
		{
			for (int oc = 0; oc < other.mSegmentCollidersCount; oc++)
	...
	public void kynetics(PhysicObject other, float normal)
	{
